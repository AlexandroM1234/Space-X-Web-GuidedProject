...
test("clicking on button fetches data and renders it to the DOM", async () => {
  //mock the resolve data
  ...
  await waitFor(() => expect(queryAllByTestId(/missions/i)).toHaveLength(3));
  // query for the missions array/assert that it is returned
